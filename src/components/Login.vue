    ...
    <v-main>
        ...
        >
            ...
            <v-card class="elevation-12">
                ...
                <v-card-text>
                    <v-form>
                        <v-text-field v-model="email" color="accent" label="email" outlined prepend-icon="mdi-account" type="text" required>
                        </v-text-field>
                        <v-text-field v-model="password" type="password" color="accent" label="Password" outlined prepend-icon="mdi-lock" required>
                        </v-text-field>
                    </v-form>
